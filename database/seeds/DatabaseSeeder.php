...
use App\Role, App\User, App\Post, App\Comment;
...
class DatabaseSeeder extends Seeder {
	...
	public function run()
	{
		...
		Post::create([
			'title' => 'Post 1',
			'slug' => 'post-1', 
			'summary' => '<img alt="" src="/storage/avatars/1_avatar1565901383.jpg" style="float:left; height:128px; width:128px" />' . $lipsum->getContent(50),
