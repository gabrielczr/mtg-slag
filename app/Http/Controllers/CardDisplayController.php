        ...
        if (isset($_GET['search'])) {
            ...
            if (isset($_GET['green'])) {
                if (isset($_GET['multicolor'])) {
                    ...
                    !isset($_GET['multicolor']) && (isset($_GET['blue'])) || (isset($_GET['black'])) || (isset($_GET['red'])) || (isset($_GET['green']))
                ) {
                    if (isset($_GET['green'])) {
                        $addGreen = 'g';
                    }
            ...
            if (
                isset($_GET['colorless']) && ((isset($_GET['blue'])) || (isset($_GET['black'])) || (isset($_GET['red'])) || (isset($_GET['white'])) || (isset($_GET['green'])))
            ) {
                $searchBlack = '';
                $searchBlue = '';
                $searchGreen = '';
            ...
            if (
                isset($_GET['creatureType']) && (isset($_GET['planeswalkerType']) ||
                    isset($_GET['landType']) ||
            ...
            if (
                isset($_GET['planeswalkerType']) && (isset($_GET['landType']) ||
                    isset($_GET['artifactType']) ||
                    isset($_GET['enchantmentType']) ||
                    isset($_GET['spellType']))
            ) {
            ...
            if (
                isset($_GET['landType']) && (isset($_GET['artifactType']) ||
                    isset($_GET['enchantmentType']) ||
                    isset($_GET['spellType']))
            ) {
            ...
            if (
                isset($_GET['artifactType']) && (isset($_GET['enchantmentType']) ||
                    isset($_GET['spellType']))
            ) {
            ...
            if (
                isset($_GET['enchantmentType']) && (isset($_GET['spellType']))
            ) {
            ...
            switch ($chosenOrderBy) {
                ...
                case 'orderAlphaAsc':
                    $searchOrder = 'order=name&q=';
                    break;

                    // Alphabetical order descending

                case 'orderAlphaDesc':
                    $searchOrder = 'order=name&dir=desc&q=';
                    break;

                    // Order by converted mana cost ascending

                case 'orderConvertedAsc':
                    $searchOrder = 'order=cmc&dir=asc&q=';
                    break;

                    // Order by converted mana cost descending

                case 'orderConvertedDesc':
                    $searchOrder = 'order=cmc&dir=desc&q=';
                    break;
                default:
                    $searchOrder = 'order=name&q=';
                    exit();
